...
Defines how FusionCanvas tools resolve, display, and use the active workspace context so creation, refinement, import, listing, generative, and automation workflows stay targeted to the user's current store, niche, topic, item, stage, metadata, tags, and nearby work.
