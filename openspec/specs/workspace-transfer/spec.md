...
Defines how a single workspace is exported to and imported from a portable single-file package, including manifest-based pre-flight, identity preservation, duplicate handling, name conflict resolution, untrusted-content hardening, progress and cancellation, and atomic failure behavior.
