...
Defines local-first workspace file storage expectations for managed creative files, authoritative workspace copies, structured path references, creative context associations, and missing-file boundaries.
