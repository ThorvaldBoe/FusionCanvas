...
Defines user-facing import of existing files into managed workspace storage, attachment to listing, niche, group, or store context, purpose labeling, per-context asset visibility, missing-file presentation, confirmed removal, and atomic persistence for asset operations.
