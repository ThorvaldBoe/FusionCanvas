...
Defines how FusionCanvas creates, edits, archives, restores, permanently deletes, and applies store-scoped tags used to classify listings, and how tags are presented in the Tags tab, listing tag editor, and tree tag filter.
