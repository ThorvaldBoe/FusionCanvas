    ...
    public static ItemEditDecision CanPerformOperation(Item item, ItemOperationKind operation)
    {
        ...
        if (item.Status is ItemStatus.Published or ItemStatus.Rejected)
        {
            return operation switch
            {
                ...
                ItemOperationKind.IdeaRating => new ItemEditDecision(true, "Idea rating remains available for this item."),
        ...
        return operation switch
        {
            ...
            ItemOperationKind.IdeaRating => new ItemEditDecision(true, "Idea rating is editable."),
